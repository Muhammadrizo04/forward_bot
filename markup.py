...
markup_1.add(types.KeyboardButton(text='Asosiy kanalimiz 💬'),types.KeyboardButton(text="Do'st taklif qilish ➕"),
             types.KeyboardButton(text="Taklif qilingan do'stlar 📈"),types.KeyboardButton(text="Trading darsliklar 📹"),types.KeyboardButton(text="VIPKANAL  Haqida 💎"),types.KeyboardButton(text='Bot haqidaℹ️'))
